                ...
                <div class="panel-body">
                    ...
                    <div class="panel-body">
                        ...
                        if ( has_post_thumbnail() ) {
                            ...
                            <?php 
                            //the_post_thumbnail('thumbnßail');
                            the_post_thumbnail('homepage-thumb');
                            ?>
                            </a><?php 
                        }
                        ?>
                        <p><a class="btn btn-primary btn-xs" href="<?php the_permalink(); ?>" id="post-<?php the_ID(); ?>">View details xxx</a></p>
                    </div>
                </div>
            </div>
        </div>
