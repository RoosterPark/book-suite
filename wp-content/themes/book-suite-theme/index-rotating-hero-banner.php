	       ...
	       <div class="item active">
	          ...
	          <div class="container-fluid">
	            <div class="carousel-caption filter">
					...
					<?php endif; ?>
					<p><a class="btn btn-primary btn-lg" href="http://info.suite.booking.com/request-demo/en-us" target="_blank" role="button">Request A Demo</a></p>
			...
			<?php 
	          ...
	          <div class="container-fluid">
	            <div class="carousel-caption filter">
					<?php if( get_field('slide_two_title') ): ?>
						<h1 class="text-center"><?php the_field('slide_two_title'); ?></h1>
					<?php endif; ?>
					<?php if( get_field('slide_two_caption') ): ?>
						<p><?php the_field('slide_two_caption'); ?></p>
					<?php endif; ?>
	              	<p><a class="btn btn-primary btn-lg" href="http://info.suite.booking.com/request-demo/en-us" target="_blank" role="button">Request A Demo</a></p>
	            </div>
	          </div>
			...
			<?php 
	          ...
	          <div class="container-fluid">
	            <div class="carousel-caption filter">
					<?php if( get_field('slide_three_title') ): ?>
						<h1 class="text-center"><?php the_field('slide_three_title'); ?></h1>
					<?php endif; ?>
					<?php if( get_field('slide_three_caption') ): ?>
						<p><?php the_field('slide_three_caption'); ?></p>
					<?php endif; ?>
	              	<p><a class="btn btn-primary btn-lg" href="http://info.suite.booking.com/request-demo/en-us" target="_blank" role="button">Request A Demo</a></p>
	            </div>
	          </div>
